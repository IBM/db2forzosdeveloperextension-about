...
For a quick overview of the Db2 Developer Extension interface, see [Getting started with Db2 for z/OS Developer Extension and VS Code]([https://ibm.biz/Bda2D9](https://community.ibm.com/community/user/blogs/eric-radzinski1/2024/10/08/getting-started-with-db2-for-zos-developer-extensi).
